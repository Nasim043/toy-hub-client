...
const Navbar = () => {
  ...
  return (
    <div className='bg-gray-900 lg:text-white '>
      <div className="navbar my-container mb-0">
        <div className="navbar-start">
          ...
          <Link to='/' className="text-xl sm:text-3xl font-bold flex items-center text-white">
